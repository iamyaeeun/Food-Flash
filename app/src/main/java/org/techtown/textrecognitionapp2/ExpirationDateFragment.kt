...
import kr.co.sungshin.foodflash.databinding.FragmentExpirationDateBinding
 ...
 * Use the [ExpirationDateFragment.newInstance] factory method to
...
class ExpirationDateFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ExpirationDateFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ExpirationDateFragment().apply {
